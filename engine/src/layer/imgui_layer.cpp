...
namespace real {
    ...
    void imgui_layer::handle_event(ev &ev) {
        ...
        dispatcher.dispatch<key_press_ev>([&io](key_press_ev &ev) -> bool {
            ...
            io.KeyCtrl  = io.KeysDown[static_cast<int>(REAL_KEY_LEFT_CONTROL)] || io.KeysDown[static_cast<int>(REAL_KEY_RIGHT_CONTROL)];
            io.KeyShift = io.KeysDown[static_cast<int>(REAL_KEY_LEFT_SHIFT)]   || io.KeysDown[static_cast<int>(REAL_KEY_RIGHT_SHIFT)];
            io.KeyAlt   = io.KeysDown[static_cast<int>(REAL_KEY_LEFT_ALT)]     || io.KeysDown[static_cast<int>(REAL_KEY_RIGHT_ALT)];
            io.KeySuper = io.KeysDown[static_cast<int>(REAL_KEY_LEFT_SUPER)]   || io.KeysDown[static_cast<int>(REAL_KEY_RIGHT_SUPER)];
